							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="submit" class="btn btn-default" title="开启" onclick="location.href='${pageContext.request.contextPath}/product/changeStatus.do?productStatus=1'"><i class="fa fa-check"></i>
											开启
										</button>
										<button type="submit" class="btn btn-default" title="屏蔽" onclick="location.href='${pageContext.request.contextPath}/product/changeStatus.do?productStatus=1'"onclick="location.href='${pageContext.request.contextPath}/product/changeStatus.do?productStatus=0'"><i class="fa fa-ban"></i>
											屏蔽
										</button>
									</div>
								</div>
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							...
							<c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
								<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageNum}&pageSize=${pageInfo.pageSize}">${pageNum}</a></li>
							</c:forEach>
